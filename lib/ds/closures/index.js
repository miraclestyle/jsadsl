...
module.exports.WeightedGraphEdge = require('./weighted-graph-edge');
module.exports.WeightedGraphDirectedEdge = require('./weighted-graph-directed-edge');
module.exports.FlowNetworkEdge = require('./flow-network-edge');
...
module.exports.FlowNetwork = require('./flow-network');
...
module.exports.WeightedDirectedEdge = module.exports[cfg.WeightedDirectedEdge];
